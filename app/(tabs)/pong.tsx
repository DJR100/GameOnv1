    ...
    onPanResponderMove: (_, gesture) => {
      ...
      if (gameState === 'playing' || showTutorial) {
        setPaddle(prev => {
          ...
          if (showTutorial && tutorialStep === 'paddle' && !paddleMoved) {
  ...
  const renderTutorialContent = () => {
    switch (tutorialStep) {
        ...
        return (
          <>
            ...
            <Text style={[styles.tutorialText, { color: colors.text }]}>
              This classic game has been updated with modern features.
      ...
      case 'paddle':
        return (
          <>
            <Text style={[styles.tutorialTitle, { color: colors.text }]}>Paddle Dynamics</Text>
            <Text style={[styles.tutorialText, { color: colors.text }]}>
              Move the paddle left and right by dragging your finger across the screen.
              {'\n\n'}
              Try moving the paddle now!
            </Text>
            {paddleMoved && (
              <Text style={[styles.tutorialSuccess, { color: colors.secondary }]}>
                Great job! You've mastered the paddle.
              </Text>
            )}
          </>
        );
      case 'ball':
        return (
          <>
            <Text style={[styles.tutorialTitle, { color: colors.text }]}>The Ball</Text>
            <Text style={[styles.tutorialText, { color: colors.text }]}>
              The ball launches from your paddle when you release your finger.
              {'\n\n'}
              Your goal is to keep the ball in play by bouncing it off your paddle.
            </Text>
          </>
        );
      case 'bricks':
        return (
          <>
            <Text style={[styles.tutorialTitle, { color: colors.text }]}>The Bricks</Text>
            <Text style={[styles.tutorialText, { color: colors.text }]}>
              Aim the ball at the bricks to break them.
              {'\n\n'}
              The ball will bounce off bricks, changing direction based on where it hits.
            </Text>
          </>
        );
      case 'score':
        return (
          <>
            <Text style={[styles.tutorialTitle, { color: colors.text }]}>Score Points</Text>
            <Text style={[styles.tutorialText, { color: colors.text }]}>
              Each brick you break awards you 10 points.
              {'\n\n'}
      ...
      case 'attempts':
        return (
          <>
            <Text style={[styles.tutorialTitle, { color: colors.text }]}>Game Attempts</Text>
            <Text style={[styles.tutorialText, { color: colors.text }]}>
              You have 3 attempts per session.
              {'\n\n'}
              An attempt ends when you break all bricks or the ball falls below the paddle.
            </Text>
          </>
        );
      case 'time':
        return (
          <>
            <Text style={[styles.tutorialTitle, { color: colors.text }]}>Stopwatch Timer</Text>
            <Text style={[styles.tutorialText, { color: colors.text }]}>
              The timer starts when you launch the ball and stops when your attempt ends.
              {'\n\n'}
              Try to break all bricks as quickly as possible for the best time!
            </Text>
          </>
        );
      case 'ready':
        return (
          <>
            <Text style={[styles.tutorialTitle, { color: colors.text }]}>Ready to Play?</Text>
            <Text style={[styles.tutorialText, { color: colors.text }]}>
              Now you know how to play Pong!
              {'\n\n'}
              Click "Start Game" and show everyone who the real Pong champion is!
            </Text>
          </>
        );
      default:
